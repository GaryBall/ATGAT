...
class models:
    ...
    def atgat(self,lstm_seq_len, N=170, lstm_out_size=9,
        ...
        print(K.int_shape(graph_inputs_day[0][0]))
        ...
        hour_vecs = [Dense(units=9, name="hour_dense_time_{0}".format(ts + 1))(graph_attention_2[ts]) for ts in
                     range(lstm_seq_len)]
        ...
        att_low_level = [Attention(method='ga')([daily_vec1[att], lstm_hour]) for att in range(attention_lstm)]
