...
class models:
    ...
    nbhd_size = 3, nbhd_type = 2, map_x_num = 10, map_y_num = 20, flow_type = 2, output_shape = 2, optimizer = 'adagrad', loss = 'mse', metrics=[]):
        ...
        print(K.int_shape(flatten_att_nbhd_inputs[0]))
        att_nbhd_inputs = []
        att_flow_inputs = []
